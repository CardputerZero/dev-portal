/**
 * bz2@1.0.1 (https://www.npmjs.com/package/bz2) — pure-JS bzip2 decompressor.
 * Original file: https://cdn.jsdelivr.net/npm/bz2@1.0.1/index.js (MIT, SheetJS LLC).
 * ESM wrapper: the original IIFE publishes onto `window.bz2` (or module.exports);
 * we shadow `window` with a module-local object and re-export from it, so the
 * file works as a same-origin ES module in both the page and Node tests.
 */
const window = {};
/* ---- original bz2@1.0.1 index.js below (unmodified) ---- */
...
/* ---- end original ---- */
export const decompress = window.bz2.decompress;
export default window.bz2;
